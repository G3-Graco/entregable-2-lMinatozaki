...
namespace Web.Controllers
{
    ...
    public class EquipoController : ControllerBase
    {
        ...
        [HttpPost("{id}/equipar")]
        public async Task<ActionResult<Equipo>> Equipar(int id, [FromQuery] string tipo, [FromQuery] string objeto)
        {
            try
            {
                var equipoActualizado = await _equipoService.Equipar(id, tipo, objeto);
        ...
        public async Task<ActionResult<Equipo>> Desequipar(int id, [FromQuery] string tipo)
        {
            try
            {
                var equipoActualizado = await _equipoService.Desequipar(id, tipo);
                return Ok(equipoActualizado);
            }
            catch (Exception ex)
            {
